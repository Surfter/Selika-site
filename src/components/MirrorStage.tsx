    ...
    <div ref={wrapRef} id="top" className="relative" style={{ height: "300vh" }}>
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        <motion.div className="absolute inset-0" style={{ pointerEvents: heroPE }}>
          ...
          <div ref={heroSlot} aria-hidden className="absolute top-1/2 -translate-y-1/2" style={{ left: "clamp(2rem, 9vw, 10rem)", width: "min(37vh, 21rem)", aspectRatio: "4 / 5.9" }} />
          <div className="absolute inset-0 flex items-start justify-center pt-[15vh]" style={{ paddingLeft: "calc(min(37vh, 21rem) + clamp(2rem, 9vw, 10rem) + 2.5rem)" }}>
