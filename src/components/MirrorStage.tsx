  ...
  return (
    <div className="relative h-full w-full" style={{ transformStyle: "preserve-3d" }}>
      ...
      <div className="absolute inset-0 rounded-[28px] glass glass-strong flex items-center justify-center" style={{ position: "absolute", transform: "rotateY(180deg) translateZ(1px)", backfaceVisibility: "hidden" }}>
        <div className="w-[52%]"><Mark size="100%" /></div>
      </div>
      {/* front face */}
    ...
    <div ref={wrapRef} id="top" className="relative" style={{ height: "300vh" }}>
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        <motion.div className="absolute inset-0" style={{ pointerEvents: heroPE }}>
          {/* where the mirror lives while the hero is up: the left side, vertically centred */}
          <div ref={heroSlot} aria-hidden className="absolute top-1/2 -translate-y-1/2" style={{ left: "clamp(1.5rem, 6vw, 7.5rem)", width: "min(28vh, 16rem)", aspectRatio: "4 / 5.9" }} />
          <div className="absolute inset-0 flex items-center justify-center pb-[4vh]" style={{ paddingLeft: "calc(min(28vh, 16rem) + clamp(1.5rem, 6vw, 7.5rem) + 2rem)" }}>
