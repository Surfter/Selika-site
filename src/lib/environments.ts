...
const K_MIN = ENVS[0].k, K_MAX = ENVS[ENVS.length - 1].k;
const M_MIN = 1e6 / K_MIN, M_MAX = 1e6 / K_MAX;
export const kToT = (k: number) => (M_MIN - 1e6 / k) / (M_MIN - M_MAX);
export const tToK = (t: number) => 1e6 / (M_MIN - t * (M_MIN - M_MAX));
